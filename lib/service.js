...
function extendSuperAgent() {
  ...
  RequestProto.get = function() {
    log('woooot')
    return superagent.get.apply(this, arguments)
  }

  RequestProto.post = function() {
    return superagent.post.apply(this, arguments)
  }

  RequestProto.del = function()  {
    return superagent.del.apply(this, arguments)
  }
