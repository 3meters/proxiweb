...
exports.addRoutes = function(app) {
  ...
  app.route('/:clName/:_id/:linkType/:direction/:linkedClName/create')
    .get(showCreateLinked)

  app.route('/:clName/:_id/:linkType/:direction/:linkedClName')
    .get(getLinked)
    .post(postLinked)
...
function whitelistMethods(req, res, next) {
  ...
  if ((method === 'post' || method === 'del' || method === 'delete')
      && req.locals.user) {
    return next()
  }
